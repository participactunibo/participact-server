...
<html>
    <head>
        <title>Contratto Cellulare</title>
    <style>
        * {
            margin: 0;
            padding 0
...
<!--     <body onload="window.print()"> -->
    <body>
        ...
        <br/>
        <h1>Modulo di PRESA IN CARICO telefono<br/>per il progetto ParticipAct</h1>
        <p>La firma del presente verbale porta all'assunzione della qualifica di Utilizzatore e comporta l’assunzione di tutte le condizioni di cui al Regolamento di Servizio ParticipAct – A.A. 2014-2015. Al termine dell'utilizzo l'attrezzatura deve essere restituita alla struttura preposta.</p>
        <br/>
        <p><c:choose>
        ...
        <br/>
        <p><em>dichiara di <strong>prendere in consegna</strong> il seguente telefono identificato da IMEI sotto riportato, di aver <strong>presa visione</strong> e di <strong>impegnarsi a rispettare</strong> quanto riportato nel Regolamento di Servizio per il progetto ParticipAct.</em></p>
        <br/>
        <p>Modello Samsung Galaxy S III Mini (GT-I8190)</p>
        <p>IMEI <c:out value="${user.imei}" /></p>
        <br />
