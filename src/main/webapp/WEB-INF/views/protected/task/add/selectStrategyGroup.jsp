	...
	<div class="container">
		<div class="row">
			...
			<div class="span9">
				...
				<form:form modelAttribute="strategyHolder" action="${flowExecutionUrl}">
					<t:select items="${availablePointsStrategies}" path="id" label="Strategy"/>
