		...
		<div class="row">
			...
			<div class="span9">
				<div class="page-header">
					<h1>Add photo action to task &quot;<c:out value="${task.name}" />&quot;</h1>
				</div>
				<form:form modelAttribute="actionPhoto" action="${flowExecutionUrl}">
					<t:input path="name" label="Description" />
					<t:input path="numeric_threshold" label="Number of photos to take" />
