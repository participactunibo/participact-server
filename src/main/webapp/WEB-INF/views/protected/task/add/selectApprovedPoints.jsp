		...
		<div class="row">
			...
			<div class="span9">
				<div class="page-header">
					<h1>
						Select points to assign to the creator of the task
					</h1>
				</div>
				<form:form modelAttribute="approvedPointsHolder" action="${flowExecutionUrl}">
					<t:input path="value" label="Points" />
