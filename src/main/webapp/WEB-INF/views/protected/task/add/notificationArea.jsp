...
$(document).ready(function() {
	...
	map.on('draw:created', function (e) {
		if (e.layerType == 'polygon') {
			...
			polycircle = createGeodesicPolygon(e.layer.getLatLng().lng, e.layer.getLatLng().lat, e.layer.getRadius(), 16, 0);
		...
		<div class="row">
			...
			<div class="span9">
				<div class="page-header">
					<h1>Draw notification area</h1>
					<p>Use the drawing tools below to draw the notification area. When you are done click on the &quot;generate
			...
			<div class="span12">
				...
				<form:form modelAttribute="task" action="${flowExecutionUrl}">
					<t:textarea
						label="Notification area WKT representation"
						path="notificationArea" cssClass="input-block-level" />
