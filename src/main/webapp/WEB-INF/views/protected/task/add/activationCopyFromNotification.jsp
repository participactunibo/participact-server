		...
		<div class="row">
			...
			<div class="span9">
				...
				<form:form modelAttribute="task" action="${flowExecutionUrl}">
					<p>
						<button class="btn btn-primary" type="submit" name="_eventId_new_activation_area">Create an activation area</button>
						<button class="btn btn-primary" type="submit" name="_eventId_copy_from_notification_area">Copy activation area from notification area</button>
					</p>
					<p>
