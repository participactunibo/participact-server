...
<body>
	...
	<div class="jumbotron subhead">
		<div class="container">
			<h1>
				Add Users to task #<c:out value="${task.id}" /> &quot;<c:out value="${task.name}" />&quot;
			</h1>
		</div>
	</div>
	<div class="container">
		<div class="row">
			...
			<div class="span9">
				...
				<p>
					<c:out value="${taskAssignedUsersForm.userList}" />
				</p>
				<form:form action="${flowExecutionUrl}">
					<button class="btn btn-danger" type="submit" name="_eventId_cancel">Cancel</button>
					<button class="btn btn-primary" type="submit" name="_eventId_next">Finish</button>
				</form:form>
			</div>
		</div>
	</div>
