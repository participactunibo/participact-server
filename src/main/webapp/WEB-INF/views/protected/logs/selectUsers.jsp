		...
		<div class="row">
			<div class="span3 bs-docs-sidebar">
				<jsp:include page="/WEB-INF/templates/dashboardSidenav.jsp">
					<jsp:param value="protected.dashboard.logs.get" name="subsection" />
				</jsp:include>
			</div>
			<div class="span9">
				<h1>Select users</h1>
				<spring:url value="/protected/logs/request" var="formAction" />
				<form:form method="POST" modelAttribute="selectUsersForm" action="${formAction}">
					<fieldset>
