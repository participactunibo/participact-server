...
/**
 * Service for SocialPresence entities.
 * 
 *
 * @see SocialPresence
 *
 */
public interface SocialPresenceService {
	...
	/**
	 * Returns Participact Users on given social network using their social ids.
	 * 
	 * @param socialNetwork social network used to look up
	 * @param socialIds social ids to look up for
	 * @return List of Participact User
	 */
	List<User> getFriendsOnSocialNetwork(SocialPresenceType socialNetwork,
			Set<String> socialIds);
